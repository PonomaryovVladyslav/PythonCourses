...
Если вы не стирали урл для админки, то он уже у вас есть, если стирали, то допишите в `blog_project/urls.py`
...
Для нашего блога этого достаточно — мы будем связывать с юзером другие модели.
