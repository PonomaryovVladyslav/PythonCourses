...
`django-celery-beat` - настройка для переодических задач, сразу вшитая в админку джаго, за подробностями опять же в
доку.


Практика\Домашка:

1. Настроить у себя селери, что бы хоть запускались хоть какие-то таски
