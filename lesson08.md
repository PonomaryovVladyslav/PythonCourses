...
Самый простой способ для создания пары ключей для `SSH` — использовать консоль Linux. Если вы используете Windows,
то вы можете использовать консоль, которая была установлена вместе с Git. Там эти команды тоже будут работать.
