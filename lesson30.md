...
1. Разработать книжную библиотеку. Храним книги, храним авторов, книгу могут написать несколько соавторов. храним кто
   брал книги, и доступна ли книга сейчас.

1.1* Разработать экшен для админки, который будет возвращать выбранные книги обратно в
библиотеку. [Дока](https://docs.djangoproject.com/en/3.1/ref/contrib/admin/actions/)

2. Разработать набор моделей, для сайта-блога, на котором можно выставлять свои статьи, комментировать чужие, ставить
   лайк и дизлайк статье, и комментарию.

2.1* Доделать так, что бы связи позволяли комментировать комментарии.

2.2* Сделать лайки через GenericForeignKey