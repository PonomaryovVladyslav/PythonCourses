...
После завершения работы над новой функцией или исправлением необходимо слить ветку с основной — мы ради этого всё и затевали.
...
Самая неприятная вещь при работе с Git — это конфликты. Предположим, что в одной ветке мы изменили какую-то функцию, а
потом в другой ветке мы изменили её же и пытаемся слить обе ветки в третью. В таком случае у нас обязательно возникнет
...
Иногда необходимо игнорировать определённые файлы или директории (почти всегда). Для этого создайте файл `.gitignore` в
