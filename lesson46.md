...
чаще файлы всё-таки передаются через git, если мы говорим о развёртывании серверов).
...
Обычно эти ключи генерируются сразу на удалённом сервере, куда мы впоследствии собираемся подключаться. Для того чтобы
мы могли подключиться, закрытый ключ нужно переместить в правильную папку с правильным названием файла 
`authorized_keys`.
