...
Вы уже вызывали так называемые `built-in` функции, например `print`, `input`, `len`, `range` и т.д. Как вы уже, наверное, поняли, функции можно писать и самому.
